...
class SearchFieldWidget extends StatefulWidget {
  ...
  const SearchFieldWidget({
    ...
    this.radius,
    this.prefixIcon,
    this.isFocused = false, this.prefixIconColor,
  });
...
class _SearchFieldWidgetState extends State<SearchFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      inputFormatters: [FilteringTextInputFormatter.deny(RegExp(r'[!@#$%^&*(),.?":{}|<>_+-/~`•√π÷×§∆£¢€¥°=©®™✓;]'))],
      decoration: InputDecoration(
        hintText: widget.hint,
        hintStyle: fontRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Color.fromRGBO(48, 48, 48, 1)),
        ...
        prefixIcon: widget.prefixIcon != null
            ? Icon(
                widget.prefixIcon,
                size: 24,
                color: widget.prefixIconColor ?? Colors.grey[900],
